...
ALTER TABLE Infomation ADD CONSTRAINT Image_Infomation_fk
FOREIGN KEY (img_id)
REFERENCES Image (img_id)
ON DELETE NO ACTION
ON UPDATE NO ACTION

ALTER TABLE Admin ADD CONSTRAINT Infomation_Admin_fk
FOREIGN KEY (info_id)
REFERENCES Infomation (info_id)
ON DELETE NO ACTION
ON UPDATE NO ACTION

ALTER TABLE User_1 ADD CONSTRAINT Infomation_User_1_fk
FOREIGN KEY (info_id)
REFERENCES Infomation (info_id)
ON DELETE NO ACTION
ON UPDATE NO ACTION
...
INSERT INTO Image (file_name, url, file_type, uploaded_date, description, create_date, update_date)
VALUES
('2030_nhung_xu_huong_lon_dinh_hinh_tuong_lai.jpg', 'img/2030_nhung_xu_huong_lon_dinh_hinh_tuong_lai.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách 2030', GETDATE(), NULL),
('33_chien_luoc_cua_chien_tranh.jpg', 'img/33_chien_luoc_cua_chien_tranh.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách chiến lược', GETDATE(), NULL),
('38_buc_thu_rockefeller_viet_cho_con_trai.jpg', 'img/38_buc_thu_rockefeller_viet_cho_con_trai.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách Rockefeller', GETDATE(), NULL),
('48_nguyen_tac_chu_chot_cua_quyen_luc.jpg', 'img/48_nguyen_tac_chu_chot_cua_quyen_luc.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách quyền lực', GETDATE(), NULL),
('7_buoc_de_thay_doi_cuoc_doi.jpg', 'img/7_buoc_de_thay_doi_cuoc_doi.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách thay đổi', GETDATE(), NULL),
('chia_se_tu_trai_tim.jpg', 'img/chia_se_tu_trai_tim.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách chia sẻ', GETDATE(), NULL),
('con_duong_chang_may_ai_di.jpg', 'img/con_duong_chang_may_ai_di.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách tâm lý', GETDATE(), NULL),
('cai_chet_cua_nen_dan_chu.jpg', 'img/cai_chet_cua_nen_dan_chu.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách lịch sử', GETDATE(), NULL),
('cay_cam_ngot_cua_toi.jpg', 'img/cay_cam_ngot_cua_toi.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách cảm động', GETDATE(), NULL),
('hieu_ve_trai_tim.jpg', 'img/hieu_ve_trai_tim.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách cảm xúc', GETDATE(), NULL),
('how_psychology_works.jpg', 'img/how_psychology_works.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách tâm lý học', GETDATE(), NULL),
('khong_bao_gio_that_bai.jpg', 'img/khong_bao_gio_that_bai.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách nghị lực', GETDATE(), NULL),
('kiep_nao_ta_cung_tim_thay_nhau.jpg', 'img/kiep_nao_ta_cung_tim_thay_nhau.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách nhân duyên', GETDATE(), NULL),
('lam_chu_business_analytics.jpg', 'img/lam_chu_business_analytics.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách phân tích dữ liệu', GETDATE(), NULL),
('len_nhat_chuyen_doi.jpg', 'img/len_nhat_chuyen_doi.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa tập truyện', GETDATE(), NULL),
('mot_thoang_ta_ruc_ro.jpg', 'img/mot_thoang_ta_ruc_ro.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa văn học', GETDATE(), NULL),
('nghi_giau_lam_giau.jpg', 'img/nghi_giau_lam_giau.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách tư duy', GETDATE(), NULL),
('nguoi_ba_tai_gioi_vung_saga.jpg', 'img/nguoi_ba_tai_gioi_vung_saga.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa câu chuyện gia đình', GETDATE(), NULL),
('nguoi_dan_ong_mang_ten_ove.jpg', 'img/nguoi_dan_ong_mang_ten_ove.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa tiểu thuyết', GETDATE(), NULL),
('nha_gia_kim.jpg', 'img/nha_gia_kim.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách triết học', GETDATE(), NULL),
('noi_chuyen_giu_mieng_im_lang.jpg', 'img/noi_chuyen_giu_mieng_im_lang.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách giao tiếp', GETDATE(), NULL),
('nuoc_my_trong_mat_trump.jpg', 'img/nuoc_my_trong_mat_trump.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách chính trị', GETDATE(), NULL),
('suoi_am_mat_troi.jpg', 'img/suoi_am_mat_troi.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách tiếp nối', GETDATE(), NULL),
('thuat_thao_tung.jpg', 'img/thuat_thao_tung.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách tâm lý', GETDATE(), NULL),
('tham_tu_lung_danh_conan.jpg', 'img/tham_tu_lung_danh_conan.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách trinh thám', GETDATE(), NULL),
('thoi_dai_ai.jpg', 'img/thoi_dai_ai.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách trí tuệ nhân tạo', GETDATE(), NULL),
('truong_ca_achilles.jpg', 'img/truong_ca_achilles.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa văn học cổ điển', GETDATE(), NULL),
('trang.jpg', 'img/trang.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách văn học', GETDATE(), NULL),
('tam_ly_hoc_toi_pham.jpg', 'img/tam_ly_hoc_toi_pham.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách khoa học pháp luật', GETDATE(), NULL),
('tam_ly_hoc_ve_tien.jpg', 'img/tam_ly_hoc_ve_tien.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa tâm lý tài chính', GETDATE(), NULL),
('toi_noi_gi_khi_chay_bo.jpg', 'img/toi_noi_gi_khi_chay_bo.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách tự truyện', GETDATE(), NULL),
('tu_duy_mo.jpg', 'img/tu_duy_mo.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách phát triển bản thân', GETDATE(), NULL),
('tu_duy_nguoc.jpg', 'img/tu_duy_nguoc.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách đổi mới', GETDATE(), NULL),
('tu_tot_den_vi_dai.jpg', 'img/tu_tot_den_vi_dai.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách quản trị', GETDATE(), NULL),
('dac_nhan_tam.jpg', 'img/dac_nhan_tam.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa sách giao tiếp nghệ thuật', GETDATE(), NULL),
('dua_tre_hieu_chuyen.jpg', 'img/dua_tre_hieu_chuyen.jpg', 'image/jpeg', GETDATE(), N'Ảnh bìa truyện ý nghĩa', GETDATE(), NULL);
