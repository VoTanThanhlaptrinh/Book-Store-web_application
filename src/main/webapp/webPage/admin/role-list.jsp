                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="topbar-item">
                            <button type="button" class="button-toggle-menu me-2">
                                <iconify-icon icon="solar:hamburger-menu-broken" class="fs-24 align-middle"><template
                                        shadowrootmode="open">
                        ...
                        <!-- Menu Toggle Button -->
                        <div class="topbar-item">
                            <h4 class="fw-bold topbar-button pe-none text-uppercase mb-0">Roles List</h4>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center gap-1">
                        ...
                        <div class="topbar-item">
                            <button type="button" class="topbar-button" id="light-dark-mode">
                                <iconify-icon icon="solar:moon-bold-duotone" class="fs-24 align-middle"><template
                                        shadowrootmode="open">
                                        <style data-style="data-style">
                                            :host {
                                                display: inline-block;
                        ...
                        <div class="dropdown topbar-item">
                            <button type="button" class="topbar-button position-relative"
                                ...
                                aria-expanded="false">
                                <iconify-icon icon="solar:bell-bing-bold-duotone" class="fs-24 align-middle"><template
                                        shadowrootmode="open">
                                        <style data-style="data-style">
                                            :host {
                                                display: inline-block;
                                                    ...
                                                    <div class="simplebar-content" style="padding: 0px;">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    <p class="mb-0"><span class="fw-medium">Josephine
                                                                            Thompson </span>commented on admin panel
                                                                        <span>" Wow ð! this admin looks good and
                                                                            awesome design"</span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    ...
                                                                    <p class="mb-0 text-wrap">Answered to your comment
                                                                        on the cash flow forecast's graph ð.</p>
                                                                </div>
                                                            </div>
                                                        </a>
                                                        <!-- Item -->
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    <p class="mb-0 fw-semibold text-wrap">You have
                                                                        received <b>20</b> new messages in the
                                                                        conversation</p>
                                                                </div>
                                                            </div>
                                                        </a>
                        ...
                        <div class="topbar-item d-none d-md-flex">
                            <button type="button" class="topbar-button" id="theme-settings-btn"
                                ...
                                <iconify-icon icon="solar:settings-bold-duotone" class="fs-24 align-middle"><template
                                        shadowrootmode="open">
                                        <style data-style="data-style">
                                            :host {
                                                display: inline-block;
                        ...
                        <div class="dropdown topbar-item">
                            <a type="button" class="topbar-button" id="page-header-user-dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle" width="32" src="../webPage/admin/assets/images/users/avatar-1.jpg"
                                        alt="avatar-3">
                                </span>
                            </a>
                                                        ...
                                                        <div class="ms-2">
                                                            ...
                                                            <p class="d-flex align-items-center gap-1 mt-1">Earned a
                                                                <iconify-icon icon="iconamoon:certificate-badge-duotone"
                                                                    ...
                                                                    </template></iconify-icon>" Best Product Award"
                                                            </p>
                            ...
                            <table class="table align-middle mb-0 table-hover table-centered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="../webPage/admin/assets/images/icon/facebook.png" class="avatar-xs rounded-circle me-1" alt="...">
                                            Facebook
                                        </td>
                                        <td> <span
                                                class="badge bg-light-subtle text-muted border py-1 px-2">Manager</span>
                                            <span
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <div class="avatar">
                                                    <img src="../webPage/admin/assets/images/users/avatar-4.jpg" alt="" class="rounded-circle avatar-sm">
                                                </div>
                                                <div class="avatar">
                                                    <span
                                                        class=" avatar-sm d-flex align-items-center justify-content-center bg-danger-subtle text-danger rounded-circle fw-bold shadow">
                                                        P
                                                    </span>
                                                </div>
                                                <div class="avatar">
                                                    <img src="../webPage/admin/assets/images/users/avatar-3.jpg" alt="" class="rounded-circle avatar-sm">
                                                </div>
                                                <div class="avatar">
                                                    <img src="../webPage/admin/assets/images/users/avatar-6.jpg" alt="" class="rounded-circle avatar-sm">
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Product Owner</td>
                                        <td>
                                            <img src="../webPage/admin/assets/images/icon/slack.png" class="avatar-xs rounded-circle me-1" alt="..."> Slack
                                        </td>
                                        <td> <span
                                                class="badge bg-light-subtle text-muted border py-1 px-2">Manager</span>
                                            <span
                                                class="badge bg-light-subtle text-muted border py-1 px-2">Product</span>
                                            <span class="badge bg-light-subtle text-muted border py-1 px-2">Data</span>
                                        </td>
                                        <td>
                                            <div class="avatar-group">
                                                <div class="avatar">
                                                ...
                                                <div class="avatar">
                                                    <img src="../webPage/admin/assets/images/users/avatar-7.jpg" alt="" class="rounded-circle avatar-sm">
                                                </div>
                                                <div class="avatar">
                                                    <span
                                                        class=" avatar-sm d-flex align-items-center justify-content-center bg-info-subtle text-info rounded-circle fw-bold shadow">
                                                        +12
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="../webPage/admin/assets/images/icon/zoom.png" class="avatar-xs rounded-circle me-1" alt="..."> Zoom
                                        </td>
                                        <td><span
                                                class="badge bg-light-subtle text-muted border py-1 px-2">Designer</span>
                                            <span class="badge bg-light-subtle text-muted border py-1 px-2">Data</span>
                                        </td>
                                        <td>
                                            <div class="avatar">
                                                <img src="../webPage/admin/assets/images/users/avatar-10.jpg" alt="" class="rounded-circle avatar-sm">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-check form-switch">
                                    ...
                                    <tr>
                                        <td>Data Analyst</td>
                                        <td>
                                            <img src="../webPage/admin/assets/images/icon/google-analytics.png" class="avatar-xs rounded-circle me-1"
                                                alt="..."> Analytics
                                        </td>
                                        <td> <span class="badge bg-light-subtle text-muted border py-1 px-2">Data</span>
                                        </td>
                                        <td>
                                            <div class="avatar-group">
                                                <div class="avatar">
                                                ...
                                                <div class="avatar">
                                                    <img src="../webPage/admin/assets/images/users/avatar-11.jpg" alt="" class="rounded-circle avatar-sm">
                                                </div>
                                                <div class="avatar">
                                                    <img src="../webPage/admin/assets/images/users/avatar-12.jpg" alt="" class="rounded-circle avatar-sm">
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="../webPage/admin/assets/images/icon/google-meet.png" class="avatar-xs rounded-circle me-1" alt="...">
                                            Meet
                                        </td>
                                        <td> <span class="badge bg-light-subtle text-muted border py-1 px-2">System
                                                Design</span></td>
                                        <td>
                                            <div class="avatar-group">
                                                <div class="avatar">
                                                    <span
                                                        class=" avatar-sm d-flex align-items-center justify-content-center bg-primary-subtle text-primary rounded-circle fw-bold shadow">
                                                        A
                                                    </span>
                                                </div>
                                                <div class="avatar">
                                                ...
                                                <div class="avatar">
                                                    <span
                                                        class=" avatar-sm d-flex align-items-center justify-content-center bg-warning-subtle text-warning rounded-circle fw-bold shadow">
                                                        K
                                                    </span>
                                                </div>
                                                <div class="avatar">
                                                    <span
                                                        class=" avatar-sm d-flex align-items-center justify-content-center bg-dark text-white rounded-circle fw-bold shadow">
                                                        +17
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="../webPage/admin/assets/images/icon/google-mail.png" class="avatar-xs rounded-circle me-1" alt="...">
                                            Mail
                                        </td>
                                        <td> <span
                                                class="badge bg-light-subtle text-muted border py-1 px-2">Manager</span>
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <div class="avatar">
                                                    <img src="../webPage/admin/assets/images/users/avatar-2.jpg" alt="" class="rounded-circle avatar-sm">
                                                </div>
                                                <div class="avatar">
                                                    <img src="../webPage/admin/assets/images/users/avatar-12.jpg" alt="" class="rounded-circle avatar-sm">
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="../webPage/admin/assets/images/icon/stripe.png" class="avatar-xs rounded-circle me-1" alt="..."> Strip
                                        </td>
                                        <td> <span class="badge bg-light-subtle text-muted border py-1 px-2">QA</span>
                                        </td>
                                        <td>
                                            <div class="avatar">
                                                <span
