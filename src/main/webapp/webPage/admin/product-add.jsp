...
<!-- Title Meta -->
<meta charset="utf-8" />
<title>Create Product | Larkon - Responsive Admin Dashboard
	Template</title>
										...
										<p class="d-flex align-items-center">
											Add 3 files to <span
												class=" d-flex align-items-center text-primary ms-1"><iconify-icon
													icon="iconamoon:file-light"></iconify-icon> Tasks</span>
										</p>
										<div class="bg-light bg-opacity-50 rounded-2 p-2">
											<div class="row">
												<div class="col-lg-6 border-end border-light">
													<div class="d-flex align-items-center gap-2">
														<i class="bx bxl-figma fs-20 text-red"></i> <a href="#!"
												...
												<div class="col-lg-6">
													<div class="d-flex align-items-center gap-2">
														<i class="bx bxl-file-doc fs-20 text-success"></i> <a
															href="#!" class="text-dark fw-medium">larkon.docs</a>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="mb-4">
									...
									<div class="ms-2">
										...
										<div class="row g-2 mt-2">
											<div class="col-lg-4">
												<a href="#!"> <img
													src="../webPage/admin/assets/images/small/img-6.jpg" alt=""
													class="img-fluid rounded">
												</a>
											</div>
											<div class="col-lg-4">
												<a href="#!"> <img
													src="../webPage/admin/assets/images/small/img-3.jpg" alt=""
													class="img-fluid rounded">
												</a>
											</div>
											<div class="col-lg-4">
												<a href="#!"> <img
													src="../webPage/admin/assets/images/small/img-4.jpg" alt=""
													class="img-fluid rounded">
												</a>
											</div>
										</div>
							...
							<div>
								...
								<div class="form-check mb-2">
									<input class="form-check-input" type="radio"
										...
										class="form-check-label" for="leftbar-size-small-hover-active">
										Small Hover Active </label>
								</div>
...
span, svg {
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="dz-message needsclick">
										...
										<h3 class="mt-4">
											Drop your images here, or <span class="text-primary">click
												to browse</span>
										</h3>
										...
										<div class="col-lg-12">
											<div class="mb-3">
												...
												<textarea class="form-control bg-light-subtle"
													...
													placeholder="Short description about the product" required></textarea>
											</div>
										</div>
									</div>
									<div class="row">
								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-lg-4">
											...
											<div class="input-group mb-3">
												<span class="input-group-text fs-20"><i
													class='bx bxs-file-txt'></i></span> <input type="number"
	...
	<script src="../webPage/admin/assets/js/product_add_main.js"></script>
