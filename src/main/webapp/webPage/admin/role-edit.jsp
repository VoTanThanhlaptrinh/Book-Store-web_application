										...
										<c:forEach var="resource" items="${resources}">
											<tr>
												...
												<td>
													<div class="form-check form-switch">
														<input class="form-check-input" type="checkbox"
															id="flexSwitchCheckChecked1" value="${resource.url}:1"
														<c:forEach var="ur" items="${userResource}">
										                   <c:if test="${ur.url == resource.url && (ur.permission == 1) && ur.permission != 0}">
										                         checked
										                    </c:if>
										                 </c:forEach>
										                    >
												...
												<td>
													<div class="form-check form-switch">
														<input class="form-check-input" type="checkbox"
															id="flexSwitchCheckChecked2" value="${resource.url}:2"
															<c:forEach var="ur" items="${userResource}">
										                   <c:if test="${ur.url == resource.url && (ur.permission == 2) && ur.permission != 0}">
										                         checked
										                    </c:if>
										                 </c:forEach>
										                 >
												...
												<td>
													<div class="form-check form-switch">
														<input class="form-check-input" type="checkbox"
															id="flexSwitchCheckChecked3" value="${resource.url}:4"
															<c:forEach var="ur" items="${userResource}">
										                   <c:if test="${ur.url == resource.url && (ur.permission == 4) && ur.permission != 0}">
										                         checked
										                    </c:if>
										                 </c:forEach>>
													</div>
