...
<body>
                                    ...
                                    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                         <div class="carousel-inner" role="listbox">
                                              <div class="carousel-item active">
                                                   <img src="../webPage/admin/assets/images/product/p-1.png" alt="" class="img-fluid bg-light rounded">
                                              </div>
                                              <div class="carousel-item">
                                                   <img src="../webPage/admin/assets/images/product/p-10.png" alt="" class="img-fluid bg-light rounded">
                                              </div>
                                              <div class="carousel-item">
                                                   <img src="../webPage/admin/assets/images/product/p-13.png" alt="" class="img-fluid bg-light rounded">
                                              </div>
                                              <div class="carousel-item">
                                                   <img src="../webPage/admin/assets/images/product/p-14.png" alt="" class="img-fluid bg-light rounded">
                                              </div>
                                         ...
                                         <div class="carousel-indicators m-0 mt-2 d-lg-flex d-none position-static h-100">
                                              <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="0" aria-current="true" aria-label="Slide 1" class="w-auto h-auto rounded bg-light active">
                                                   <img src="../webPage/admin/assets/images/product/p-1.png" class="d-block avatar-xl" alt="swiper-indicator-img">
                                              </button>
                                              <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="1" aria-label="Slide 2" class="w-auto h-auto rounded bg-light">
                                                   <img src="../webPage/admin/assets/images/product/p-10.png" class="d-block avatar-xl" alt="swiper-indicator-img">
                                              </button>
                                              <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="2" aria-label="Slide 3" class="w-auto h-auto rounded bg-light">
                                                   <img src="../webPage/admin/assets/images/product/p-13.png" class="d-block avatar-xl" alt="swiper-indicator-img">
                                              </button>
                                              <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="3" aria-label="Slide 3" class="w-auto h-auto rounded bg-light">
                                                   <img src="../webPage/admin/assets/images/product/p-14.png" class="d-block avatar-xl" alt="swiper-indicator-img">
                                              </button>
                                         </div>
                                    </div>
                               </div>
                ...
                <div class="row">
                     ...
                     <div class="col-lg-6">
                          <div class="card">
                               ...
                               <div class="card-body">
                                    <div class="d-flex align-items-center gap-2">
                                         <img src="../webPage/admin/assets/images/users/avatar-6.jpg" alt="" class="avatar-md rounded-circle">
                                         <div>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                         <img src="../webPage/admin/assets/images/users/avatar-4.jpg" alt="" class="avatar-md rounded-circle">
                                         <div>
    ...
    <script src="../webPage/admin/assets/js/pages/product-details.js"></script>
