...
<!DOCTYPE html>
<!-- saved from url=(0049)https://techzaa.in/larkon/admin/coupons-list.html -->
																	...
																	<div class="col-lg-6 border-end border-light">
																		<div class="d-flex align-items-center gap-2">
																			<i class="bx bxl-figma fs-20 text-red"></i> <a
																				href="https://techzaa.in/larkon/admin/coupons-list.html#!"
	...
	display: block
												...
												<div class="position-relative ps-4">
													<div class="mb-4">
														<span
															...
															src="./Coupons _ Larkon - Responsive Admin Dashboard Template_files/avatar-7.jpg"
															...
															<div class="row g-2 mt-2">
																<div class="col-lg-4">
																	<a
																		href="https://techzaa.in/larkon/admin/coupons-list.html#!">
																		<img
																		src="./Coupons _ Larkon - Responsive Admin Dashboard Template_files/img-6.jpg"
																...
																<div class="col-lg-4">
																	<a
																		href="https://techzaa.in/larkon/admin/coupons-list.html#!">
																		<img
																		src="./Coupons _ Larkon - Responsive Admin Dashboard Template_files/img-3.jpg"
																		alt="" class="img-fluid rounded">
																	</a>
																</div>
																<div class="col-lg-4">
																	<a
																		href="https://techzaa.in/larkon/admin/coupons-list.html#!">
																		<img
																		src="./Coupons _ Larkon - Responsive Admin Dashboard Template_files/img-4.jpg"
																		alt="" class="img-fluid rounded">
																	</a>
																</div>
															</div>
												...
												<div class="position-relative ps-4">
													<div class="mb-4">
														<span
															class="position-absolute start-0 translate-middle-x bg-success bg-gradient d-inline-flex align-items-center justify-content-center rounded-circle text-light fs-20"><img
															src="./Coupons _ Larkon - Responsive Admin Dashboard Template_files/avatar-6.jpg"
															alt="avatar-5" class="avatar-sm rounded-circle"></span>
														<div class="ms-2">
...
span, svg {
	display: block
											...
											<a href="https://techzaa.in/larkon/admin/coupons-list.html#!"
												...
												<form class="app-search d-none d-md-block me-auto">
													<div class="position-relative">
														<input type="search" class="form-control"
															placeholder="Search Coupons and Code" autocomplete="off"
															value="">
	...
	display: block
											...
											<div class="col-lg-4">
												<h5 class="text-dark fw-medium mb-0">
													5,786 <span class="text-muted">Items</span>
												</h5>
											</div>
										</div>
									</div>
...
span, svg {
	display: block
									...
									<div class="d-block">
										<h3 class=" fw-semibold">30% Special discounts for
											customers</h3>
							...
							<div class="card-footer pt-2">
								<a href="https://techzaa.in/larkon/admin/coupons-list.html#!"
									class="btn btn-primary fw-semibold">View Plan</a>
							</div>
							<div
								class="position-absolute top-100 start-100 translate-middle z-n1 opacity-75">
							...
							<div
								...
								<div class="dropdown">
									<a href="https://techzaa.in/larkon/admin/coupons-list.html#"
										...
										data-bs-toggle="dropdown" aria-expanded="false"> This
										Month </a>
									<div class="dropdown-menu dropdown-menu-end">
										<!-- item-->
										<a href="https://techzaa.in/larkon/admin/coupons-list.html#!"
												...
												<th style="width: 20px;">
													<div class="form-check">
														<input type="checkbox" class="form-check-input"
															...
															class="form-check-label" for="customCheck1"></label>
													</div>
												</th>
											...
											<tr>
												<td>
													<div class="form-check">
														<input type="checkbox" class="form-check-input"
															...
															class="form-check-label" for="customCheck2">&nbsp;</label>
													</div>
												</td>
												<td>
													<div class="d-flex align-items-center gap-2">
														<div
															...
															<img
																src="./Coupons _ Larkon - Responsive Admin Dashboard Template_files/p-1.png"
																alt="" class="avatar-md">
														</div>
														<div>
															<a
																href="https://techzaa.in/larkon/admin/coupons-list.html#!"
																class="text-dark fw-medium fs-15">Black T-shirt</a>
												...
												<td><span
													class="badge text-success bg-success-subtle fs-12"><i
														class="bx bx-check-double"></i>Active</span></td>
												<td>
													<div class="d-flex gap-2">
														<a
															href="https://techzaa.in/larkon/admin/coupons-list.html#!"
															class="btn btn-light btn-sm"><iconify-icon
																icon="solar:eye-broken" class="align-middle fs-18">
															<template shadowrootmode="open">
																<style data-style="data-style">
:host {
	display: inline-block;
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center gap-2">
														<div
															class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
															<img
																src="./Coupons _ Larkon - Responsive Admin Dashboard Template_files/p-2.png"
																alt="" class="avatar-md">
														</div>
														<div>
															<a
																href="https://techzaa.in/larkon/admin/coupons-list.html#!"
																class="text-dark fw-medium fs-15">Olive Green
																Leather Bag</a>
															<p class="text-muted mb-0 mt-1 fs-13">
																<span>Hand Bag</span>
															</p>
												...
												<td><span
													class="badge text-danger bg-danger-subtle fs-12"><i
														class="bx bx-x"></i>Expired</span></td>
												<td>
													<div class="d-flex gap-2">
														<a
															href="https://techzaa.in/larkon/admin/coupons-list.html#!"
												...
												<td>
													<div class="d-flex align-items-center gap-2">
														<div
															class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
															<img
																src="./Coupons _ Larkon - Responsive Admin Dashboard Template_files/p-3.png"
																alt="" class="avatar-md">
														</div>
														<div>
															<a
																href="https://techzaa.in/larkon/admin/coupons-list.html#!"
																class="text-dark fw-medium fs-15">Women Golden Dress</a>
															<p class="text-muted mb-0 mt-1 fs-13">
																<span>Fashion</span>
															</p>
														</div>
												...
												<td>
													<div class="d-flex align-items-center gap-2">
														<div
															class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
															<img
																src="./Coupons _ Larkon - Responsive Admin Dashboard Template_files/p-4.png"
																alt="" class="avatar-md">
														</div>
														<div>
															<a
																href="https://techzaa.in/larkon/admin/coupons-list.html#!"
																class="text-dark fw-medium fs-15">Gray Cap For Men</a>
															<p class="text-muted mb-0 mt-1 fs-13">
																<span>Cap</span>
															</p>
														</div>
												...
												<td>
													<div class="d-flex align-items-center gap-2">
														<div
															class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
															<img
																src="./Coupons _ Larkon - Responsive Admin Dashboard Template_files/p-5.png"
																alt="" class="avatar-md">
														</div>
														<div>
															<a
																href="https://techzaa.in/larkon/admin/coupons-list.html#!"
																class="text-dark fw-medium fs-15">Dark Green Cargo
																Pent</a>
															<p class="text-muted mb-0 mt-1 fs-13">
																<span>Fashion</span>
															</p>
												...
												<td>
													<div class="d-flex align-items-center gap-2">
														<div
															class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
															<img
																src="./Coupons _ Larkon - Responsive Admin Dashboard Template_files/p-6.png"
																alt="" class="avatar-md">
														</div>
														<div>
															<a
																href="https://techzaa.in/larkon/admin/coupons-list.html#!"
																class="text-dark fw-medium fs-15">Orange Multi Color
																Headphone</a>
															<p class="text-muted mb-0 mt-1 fs-13">
												...
												<td>
													<div class="d-flex align-items-center gap-2">
														<div
															class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
															<img
																src="./Coupons _ Larkon - Responsive Admin Dashboard Template_files/p-7.png"
																alt="" class="avatar-md">
														</div>
														<div>
															<a
																href="https://techzaa.in/larkon/admin/coupons-list.html#!"
																class="text-dark fw-medium fs-15">Kid's Yellow Shoes</a>
															<p class="text-muted mb-0 mt-1 fs-13">
												...
												<td>
													<div class="d-flex align-items-center gap-2">
														<div
															class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
															<img
																src="./Coupons _ Larkon - Responsive Admin Dashboard Template_files/p-8.png"
																alt="" class="avatar-md">
														</div>
														<div>
															<a
																href="https://techzaa.in/larkon/admin/coupons-list.html#!"
																class="text-dark fw-medium fs-15">Men Dark Brown
																Wallet</a>
															<p class="text-muted mb-0 mt-1 fs-13">
																<span>Wallet</span>
															</p>
												...
												<td>
													<div class="d-flex align-items-center gap-2">
														<div
															class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
															<img
																src="./Coupons _ Larkon - Responsive Admin Dashboard Template_files/p-9.png"
																alt="" class="avatar-md">
														</div>
														<div>
															<a
																href="https://techzaa.in/larkon/admin/coupons-list.html#!"
																class="text-dark fw-medium fs-15">Sky Blue Sunglass</a>
															<p class="text-muted mb-0 mt-1 fs-13">
																<span>Sunglass</span>
															</p>
														</div>
												...
												<td>
													<div class="d-flex align-items-center gap-2">
														<div
															class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
															<img
																src="./Coupons _ Larkon - Responsive Admin Dashboard Template_files/p-10.png"
																alt="" class="avatar-md">
														</div>
														<div>
															<a
																href="https://techzaa.in/larkon/admin/coupons-list.html#!"
																class="text-dark fw-medium fs-15">Kid's Yellow
																T-shirt</a>
															<p class="text-muted mb-0 mt-1 fs-13">
																<span>Fashion</span>
															</p>
												...
												<td>
													<div class="d-flex align-items-center gap-2">
														<div
															class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
															<img
																src="./Coupons _ Larkon - Responsive Admin Dashboard Template_files/p-11.png"
																alt="" class="avatar-md">
														</div>
														<div>
															<a
																href="https://techzaa.in/larkon/admin/coupons-list.html#!"
																class="text-dark fw-medium fs-15">White Rubber Band
																Smart Watch </a>
															<p class="text-muted mb-0 mt-1 fs-13">
																<span>Electronics</span>
															</p>
												...
												<td>
													<div class="d-flex align-items-center gap-2">
														<div
															class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
															<img
																src="./Coupons _ Larkon - Responsive Admin Dashboard Template_files/p-12.png"
																alt="" class="avatar-md">
														</div>
														<div>
															<a
																href="https://techzaa.in/larkon/admin/coupons-list.html#!"
																class="text-dark fw-medium fs-15">Men Brown Leather
																Shoes </a>
															<p class="text-muted mb-0 mt-1 fs-13">
