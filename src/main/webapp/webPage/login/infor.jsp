...
<body>
	...
	<div class="info-body">
		<div class="container bg-white rounded-4 shadow-lg p-0"
			style="max-width: 80%;">
			<div class="row g-0 flex-md-row flex-column">
				...
				<div class="col-md-3 bg-light p-4 sidebar d-flex flex-column">
					...
					<a href="#" class="text-decoration-none active"
						data-form="overview"><fmt:message
							key="detail.individual.infomation" /></a> <a href="#"
						class="text-decoration-none" data-form="password"><fmt:message
							key="change.pass" /></a>
				</div>
				...
				<section class="col-md-9 p-5">
					...
					<div id="overview" class="form-box active">
						<h3 class="mb-4 fw-bold">
							<fmt:message key="detail.individual.infomation" />
						</h3>
								...
								<div class="col-md-6">
									<div class="form-floating mb-3">
										<input type="text" class="form-control shadow-sm"
											...
											value="${infor.getName()}" maxlength="100" required>
										<label for="fullname"><fmt:message key="fullName" /></label>
									</div>
									<div class="form-floating mb-3">
										<input type="email" class="form-control shadow-sm" id="email"
											name="email" placeholder="Email" value="${infor.getEmail()}"
											maxlength="255" required> <label for="email">Email</label>
									</div>
									<div class="form-floating mb-3">
										<input type="text" class="form-control shadow-sm" id="phone"
											name="phone" placeholder="Số điện thoại"
											value="${infor.getPhoneNumber()}" maxlength="11" required>
										<label for="phone"><fmt:message key="phone_number" /></label>
									</div>
									<div class="form-floating mb-3">
										<select class="form-control shadow-sm" id="gender"
											name="gender">
										...
										</select> <label for="gender"><fmt:message key="gender" /></label>
									</div>
									<div class="form-floating mb-3">
										<input type="date" class="form-control shadow-sm"
											id="birthday" name="birthday" placeholder="Ngày sinh"
											value="${infor.getBirth()}"> <label for="birthday"><fmt:message
												key="birthday" /></label>
									</div>
								</div>
									...
									<div class="profile-image-container">
										...
										<div class="form-floating mb-3">
											<button type="button" class="btn btn-secondary shadow-sm"
												...
												<fmt:message key="choose.image" />
											</button>
											<input type="file" class="form-control shadow-sm"
												id="image-upload" name="file" accept="image/*"
												onchange="previewImage(event)" style="display: none;">
											<div>
											<small class="text-muted"> <fmt:message
													key="notify.length.image" />
											</small>
											</div>
										</div>
									</div>
					...
					<div id="password" class="form-box">
						...
						<form id="changePass">
							...
							<div class="form-floating mb-3 position-relative">
								<input type="password" class="form-control shadow-sm"
									id="new-password" name="newPassword" placeholder="Mật khẩu mới"
									maxlength="255" required> <label for="new-password"><fmt:message
										key="new.password" /></label> <span class="toggle-password"
									onclick="togglePasswordVisibility('new-password')"> <i
									id="new-password-icon" class="bi bi-eye-slash"></i> <!-- Biểu tượng mắt -->
								</span>
							</div>
							<div class="form-floating mb-4 position-relative">
								<input type="password" class="form-control shadow-sm"
									id="confirm-password" name="confirmPassword"
									placeholder="Xác nhận mật khẩu mới" maxlength="255" required>
								<label for="confirm-password"><fmt:message
										key="confirm.password" /></label> <span class="toggle-password"
