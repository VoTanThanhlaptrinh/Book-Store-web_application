                ...
                <div class="signup-content border">
                    <form method="POST" id="signin" class="signup-form">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="name" id="name" placeholder="Mật khẩu mới" />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="submit" name="submit" id="submit" class="form-submit" value="Đổi mật khẩu" />
                        </div>
                    </form>
                </div>
            </div>
