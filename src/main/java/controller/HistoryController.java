...
public class HistoryController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (user == null) {
			...
			for (Order o : orders) {
				...
				String username = oImp.getFullNameByOrder(o.getOrderId());
				StringBuilder prNames = new StringBuilder();
				double totalPrice = o.getTotalAmount();
				...
				// Tinh hash
				String generatedHash = generateOrderHash(String.valueOf(o.getOrderId()), username,
						o.getCreateDate().toString(), prNames.toString(), formatAmount(totalPrice));
				...
				if (o.getSignature() == null) {
					...
					try {
						...
						String hashData = oImp.getHashData(o.getOrderId());// lấy giá trị hash lưu trong databse order, nếu chưa lưu thì
															// lấy từ session
						if (hashData == null) {
							System.out.println("Chưa lưu hash value không thể xác thực chữ kí");
							continue;
						}

						boolean checkHashValue = hashData.equals(generatedHash);
						boolean checkVerifySignature = verifySignature(generatedHash, o.getSignature(), pubKey);

						boolean valid = checkHashValue && checkVerifySignature;

						System.out.println("hashData:      "+hashData);
						System.out.println("generatedHash: "+generatedHash);
						
						System.out.println(checkHashValue);
						System.out.println(checkVerifySignature);
	...
	public static String generateOrderHash(String orderId, String customerName, String orderDate, String products,
			String totalAmount) {
